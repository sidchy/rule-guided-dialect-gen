    ...
    try:
        ...
        examples_by_scene = {
            ...
            "health_medical": [
                ...
                _example("医生", "医生看病", "health_medical", "医生还勒看病。", "医生还在看病。"),
                _example("医生", "医生看病", "health_medical", "先寻医生问问。", "先去问医生。"),
            ],
        }
        words_by_scene = {
            "food_dining": [
            ...
            "health_medical": [
                ...
                _word("挂号", "医院挂号", "health_medical"),
                _word("门诊", "医院门诊", "health_medical"),
                _word("医生", "医生看病", "health_medical"),
                _word("药水", "看病用药", "health_medical"),
            ],
        }
...
def test_create_tasks_balanced_uses_feedback_scene_weights() -> None:
    originals = {
        "build_domain_context": batch_module.build_domain_context,
        "build_task": batch_module.build_task,
        "core_is_allowed": batch_module.core_is_allowed,
    ...
    try:
        ...
        tasks = batch_module.create_tasks_balanced(
            ...
            scene_filter=["food_dining", "health_medical"],
            feedback_plan={
                "scene_weights": {"food_dining": 1.0, "health_medical": 3.0},
                "anchor_pool_top_k": 0,
