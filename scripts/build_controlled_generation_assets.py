...
SCENE_CATALOG: list[dict[str, Any]] = [
    ...
    {
        "scene_id": "digital_ai_assistant",
        "label": "AI助手",
        "intents": ["语音助手", "AI求助", "提醒设置"],
        ...
        "zh_keywords": ["AI", "助手", "语音助手", "提醒", "闹钟", "定时", "查一下", "帮我", "翻译", "总结", "设置", "打开", "手机"],
        "wz_keywords": ["手机", "提醒"],
        "default_required_modern_words": ["手机"],
        "default_preferred_modern_words": ["AI", "闹钟", "提醒"],
    },
    {
        "scene_id": "digital_messaging_call",
        "label": "消息通话",
        "intents": ["发消息", "打电话", "视频通话"],
        "communicative_functions": [
            "让人回消息或快点接电话",
            "确认微信消息有没有收到",
            "催人发定位或打视频过来",
        ...
        "zh_keywords": ["消息", "微信", "电话", "打电话", "来电", "视频", "视频通话", "语音", "回消息", "电话号码", "录音", "手机"],
        "wz_keywords": ["电话", "消息", "录音"],
        "default_required_modern_words": ["手机"],
        "default_preferred_modern_words": ["微信", "视频", "消息"],
    },
    {
        "scene_id": "digital_device_trouble",
        "label": "设备故障",
        "intents": ["手机故障", "网络问题", "电量密码"],
        "communicative_functions": [
            "抱怨信号差或手机卡牢",
            "说手机没电、充不进或开不起来",
            "问密码忘掉该怎么办",
        ...
        "zh_keywords": ["手机", "信号", "网络", "没电", "电量", "充电器", "充电宝", "密码", "卡", "卡顿", "死机", "开机", "断网", "电脑", "平板"],
        "wz_keywords": ["手机", "电话"],
        "default_required_modern_words": ["手机"],
        "default_preferred_modern_words": ["充电器", "充电宝", "密码"],
    },
    {
        "scene_id": "digital_app_operation",
        "label": "应用操作",
        "intents": ["装软件", "登录更新", "上传下载"],
        "communicative_functions": [
            "问怎么装软件或更新APP",
            "叫人帮忙登录、下载、上传文件",
            "问AI怎么发微信、传照片或开权限",
        ...
        "zh_keywords": ["软件", "APP", "应用", "安装", "更新", "登录", "下载", "上传", "发送", "截图", "权限", "微信", "文件", "视频", "手机"],
        "wz_keywords": ["手机", "发送"],
        "default_required_modern_words": ["手机"],
        "default_preferred_modern_words": ["微信", "软件", "文件"],
    },
    {
